...
class AscTecCollisionAvoidancePointSequencePlannerNode():
    ...
    def work(self):
        ...
        # initialize node
        rospy.init_node('asctec_collision_avoidance_point_sequence_planner_node')
        ...
        other_quad_name = rospy.get_param('other_name', default='')
        topic = other_quad_name + 'msf_core/odometry'
...
if __name__ == '__main__':
    node = AscTecCollisionAvoidancePointSequencePlannerNode()
    node.work()
